...
void loop() {
  // //int servoLength = promptInput("input length required between fingers (in [mm]):");
  // Serial.println("input length required between fingers (in [mm]):");
  // //while (Serial.available() == 0) {
  //   // Wait for User to Input Data
  // //}
  // if (Serial.available() > 0) {
  // servoLength = Serial.parseInt();
  // }
  // //int servoLength = Serial.parseInt();
  // Serial.println("you want to send the gripper to L=" + String(servoLength) + "[mm].");
  // moveFingers(servoLength);
  // delay(1000);
